...
This is the source code for the paper "MGS: A Flexible Methods Generation Scheme for Point Cloud Outliers Detection". The file structure description of this project is presented in the following.  
```
